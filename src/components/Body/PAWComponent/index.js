      ...
      <section className="section paw-section">
          <div className="container">
              <div className="paw-section__content">
                  ...
                  <div className="paw-section__text">
                      All war carries a cost, not only in lives, but in money. This battle is no different. To help fund their efforts,
                      ...
                      <span className="text-decorator text-decorator--blue">The same VIP PAW CARD is used to record the number of Open CHEST acquired when entering the field bay associated with the VIP PAW CARD.</span>
                      The Bear Navy salvages GOLD tokens for each field bays and distributes them proportionately to each Open CHEST in each field bays until they receive their eligible salvaged GOLD tokens (becomes a Closed Chest).
                      On withdrawal of GOLD tokens salvaged to each Open CHEST anytime, the CHEST immediately becomes Closed and ineligible to salvage GOLD tokens.
                      <span className="text-decorator text-decorator--blue">Veterans are advised to wait till their Open CHEST receives its complete eligible salvaged GOLD tokens (then Chest becomes Closed) before withdrawing their GOLD tokens.</span>
                  </div>
              </div>
          </div>
      </section>
