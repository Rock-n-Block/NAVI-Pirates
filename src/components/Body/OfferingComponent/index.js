          ...
          <div className="container">
              ...
              <div className="offering-section__content">
                  ...
                  <div className="offering-section__descr offering-section__descr--left">
                      Each VIP PAW CARD is designed the same, and they display a Bear Navy PAW Captain with a unique character set. Bear Games will create 1 000 VIP PAW NFT CARDS available for sale during the Initial NFT Offering (INO) on BEAR GAMES official website. There are infinite possibilities with what can be stored in the PAW VIP Card in future or distributed to the PAW VIP Cards as divs including ERC20 tokens. All this to increase value!
                  </div>

                  <div className="offering-section__descr offering-section__descr--left">
                      <img src={third} alt="" className="offering-section__decorator offering-section__decorator-3"/>
                      <span className="text-decorator text-decorator--blue">Each VIP PAW CARD cost 0.5 ETH. The Initial NFT Offering has a hard cap of 500 ETH and a soft cap of 200 ETH.</span>
                  </div>
